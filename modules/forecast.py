...
def run_forecast():
    """Runs the forecast. This function prompts the user for a stock ticker symbol
    and a date range, then it calculates and interprets the Sharpe and Sortino
    Ratios, the Maximum Drawdown, and the Risk-Free Rate."""
    while True:
        try:
